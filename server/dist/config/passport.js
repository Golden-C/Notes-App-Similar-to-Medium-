...
module.exports = function (passport) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, done(null, false, { message: 'Email is not in use' })];
                ...
                case 5:
                    err_1 = _a.sent();
                    console.log(err_1);
                    return [2 /*return*/, done(null, false, { message: err_1 })];
    ...
    passport.deserializeUser(function (id, done) {
        signupModel_1.default.findById(id, function (err, user) {
            done(err, user);
        });
    });
};
